...
class gpu_decode(object):
    def __init__(self, rows, cols, confidence_threshold = 0.25, nms_threshold = 0.45, stream=None):
    ...
    def decode_kernel_invoker(self, predict, affine):
        ...
        cuda.memset_d8(self.output_device, 0, self.output_device_nbytes)  #清空buffer
